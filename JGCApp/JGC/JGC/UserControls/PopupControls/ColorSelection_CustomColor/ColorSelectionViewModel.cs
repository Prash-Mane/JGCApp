...
{
    public class ColorSelectionViewModel : ColorPickerBaseViewModel
    {
        ...
        private void ColorTapped()
        {
            ...
            CurrentPageHelper.ColorPicker = IWPHelper.ColorPicker = SelectedColor.HexValue;
        } 
        ...
        public class ColorExtended : ColorPickerBaseViewModel
        {
