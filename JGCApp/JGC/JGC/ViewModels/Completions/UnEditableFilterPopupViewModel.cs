...
{
    public class UnEditableFilterPopupViewModel : BindableBase
    {
        ...
        public string InputString
        {
            ...
            set
            {
                ...
                if (!string.IsNullOrEmpty(InputString))
                    ListviewSource = FilterList.Where(x => x.ToLower() == InputString.ToLower()).ToList();
            }
        }
        ...
        public UnEditableFilterPopupViewModel(List<string> Source)
        {
