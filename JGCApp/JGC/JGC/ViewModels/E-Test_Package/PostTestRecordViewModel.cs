...
namespace JGC.ViewModels.E_Test_Package
{
    ...
    public class PostTestRecordViewModel : BaseViewModel
    {
        ...
        private readonly IRepository<T_PostTestRecordAcceptedBy> _PostTestRecordAcceptedByRepository;
        ...
        public PostTestRecordViewModel(
            ...
            IRepository<T_PostTestRecordAcceptedBy> _PostTestRecordAcceptedByRepository,
        ...
        IRepository<T_UserProject> _userProjectRepository) : base(_navigationService, _httpHelper, _checkValidLogin)
        {
            ...
            this._PostTestRecordAcceptedByRepository = _PostTestRecordAcceptedByRepository;
        ...
        private async Task LoadCertificationTabsAsync()
        {
            try
            {
                ...
                var tsk1 = await GenerateContentTableAsync(Settings.ProjectID, CurrentPageHelper.ETestPackage.ID, "T_AdminPostTestRecordContent", "T_PostTestRecordContent", CurrentUserProject);
                var tsk2 = await GenerateAcceptedByTableAsync(Settings.ProjectID, CurrentPageHelper.ETestPackage.ID, "T_AdminPostTestRecordAcceptedBy", "T_PostTestRecordAcceptedBy", CurrentUserProject);
        ...
        private async Task<List<RecordConfirmation>> GenerateContentTableAsync(int projectID, int etestPackageID, string adminDatabaseTable, string databaseTable, T_UserProject userProject)
        {
            ...
            try
            {
                ...
                var reuslt = await _adminPostTestRecordContentRepository.QueryAsync<RecordConfirmation>(SQL);
        ...
        public async Task<List<RecordAcceptedBy>> GenerateAcceptedByTableAsync(int projectID, int etestPackageID, string adminDatabaseTable, string databaseTable, T_UserProject userProject)
        {
            ...
            var result = await _PostTestRecordAcceptedByRepository.QueryAsync<RecordAcceptedBy>(SQL);
        ...
        public async void gvDrainRecordContent_CellContentClick(string param, RecordConfirmation SelectedRecord)
        {
            ...
            if (SelectedConfirmationSource != null || btnNA == true) //Status Image
            {
                ...
                if (await CanSignOffCertificiationSignature("T_AdminPostTestRecordContent", "T_PostTestRecordContent", adminID, signed, live))
                {
                    T_PostTestRecordContent signature = new T_PostTestRecordContent()
                    {
                        AdminID = adminID,
                        Signed = !signed,
                    ...
                    if (await SaveNew(Settings.ProjectID, CurrentPageHelper.ETestPackage.ID, "T_PostTestRecordContent", signature))
                    {
                        UpdateETestPackageStatus(Settings.ProjectID, CurrentPageHelper.ETestPackage.ID);
        ...
        public async void gvDrainRecordAcceptedBy_CellContentClick(string param, RecordAcceptedBy SelectedRecord)
        {
            ...
            if (SelectedrecordAcceptedBySource != null) //Status Image
            {
                ...
                if (await CanSignOffAcceptedBySignature("T_AdminPostTestRecordAcceptedBy", "T_PostTestRecordAcceptedBy", RecordConfirmationSource, adminID, signed, live, orderNo))
                {
                    ...
                    if (await SaveNew(Settings.ProjectID, CurrentPageHelper.ETestPackage.ID, "T_PostTestRecordAcceptedBy", signature))
                    {
                        if (!signed)
                        {
                            ...
                            string SQL = "SELECT * FROM [T_AdminPostTestRecordAcceptedBy] WHERE [ProjectID] = '" + Settings.ProjectID + "' AND [ID] = '" + CurrentPageHelper.ETestPackage.ID + "'";
                            var result = await _AdminPostTestRecordAcceptedByRepository.QueryAsync<T_AdminPostTestRecordAcceptedBy>(SQL);
        ...
        private async Task<Boolean> CanSignOffCertificiationSignature(string adminDatabaseTable, string databaseTable, int adminID, Boolean signed, Boolean live)
        {
            ...
            var result = await _adminPostTestRecordContentRepository.QueryAsync<T_AdminPostTestRecordContent>(SQL);
        ...
        public async Task<Boolean> SaveNew(int projectID, int etestPackageID, string databaseTable, T_PostTestRecordContent signature)
        {
            if (databaseTable == "T_PostTestRecordContent")
            {
                ...
                var sqlreturn = await _PostTestRecordContentRepository.QueryAsync(SQL);
                ...
                if (sqlreturn.Any())
                {
                    ...
                    try
                    {
                        ...
                        var data = _PostTestRecordContentRepository.QueryAsync(sql);
                        return returnvalue;
                    }
                    catch (Exception Ex)
                    {
            ...
            else
            {
                ...
                string SQL = "SELECT *  FROM [" + databaseTable + "] WHERE [ProjectID] = '" + projectID + "' AND [ETestPackageID] = '" + etestPackageID + "' AND [AdminID] = '" + signature.AdminID + "'";
                var sqlreturn = await _PostTestRecordAcceptedByRepository.QueryAsync(SQL);
                ...
                if (sqlreturn.Any())
                {
                    ...
                    try
                    {
                       ...
                       + Settings.ProjectID + "' AND [ETestPackageID] = '" + CurrentPageHelper.ETestPackage.ID + "' AND [AdminID] = '" + signature.AdminID + "'";
                        ...
                        var data = _PostTestRecordAcceptedByRepository.QueryAsync(sql);
                        return returnvalue;
                    }
                    catch (Exception Ex)
                    {
